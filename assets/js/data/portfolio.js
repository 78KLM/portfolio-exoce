...
export const skills = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Orchestration cloud-native, Haute Disponibilité (HPA, Probes), Services, ConfigMaps, Secrets.",
      },
    ],
  },
...
export const projects = [
  ...
  {
    title: "Cloud-Native Orchestration (Kubernetes / CI-CD)",
    description: "Déploiement complet et orchestration d'une application web conteneurisée sur un cluster Kubernetes. Création d'un pipeline d'intégration et de déploiement continus (CI/CD) automatisé via GitHub Actions avec publication sur GitHub Container Registry (GHCR). Mise en place de l'infrastructure as Code (YAML) et configuration de la haute disponibilité : Autoscaling (HPA), sondes de santé (Liveness/Readiness) et Rolling Updates sans coupure de service.",
    image: "assets/images/projects/k8s-orchestration.png",
    technologies: ["Kubernetes", "Docker", "GitHub Actions", "YAML", "Git", "Grafana"],
    status: "termine",
    statusLabel: "Terminé",
    startDate: "Mars 2026",
    endDate: "Mars 2026",
    github: "https://github.com/78KLM/Cloud-Native-Microservices-Orchestration-Kubernetes", 
    live: null,
    highlight: true,
  },
